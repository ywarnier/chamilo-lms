...
use Chamilo\CoreBundle\Repository\StaffStatusRepository;
...
#[ApiResource(
    ...
    normalizationContext: ['groups' => ['staff_status:read']],
    denormalizationContext: ['groups' => ['staff_status:write']],
)]
#[ORM\Table(name: 'staff_status')]
#[ORM\Entity(repositoryClass: StaffStatusRepository::class)]
class StaffStatus
{
    #[Groups(['staff_status:read'])]
    ...
    #[Assert\NotBlank]
    #[Groups(['staff_status:read', 'staff_status:write'])]
